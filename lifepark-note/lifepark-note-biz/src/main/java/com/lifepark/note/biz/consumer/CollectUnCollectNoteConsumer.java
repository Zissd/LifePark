...
@Component
@RocketMQMessageListener(consumerGroup = "lifepark_group_" + MQConstants.TOPIC_COLLECT_OR_UN_COLLECT, // Group 组
...
public class CollectUnCollectNoteConsumer implements RocketMQListener<Message> {
    ...
    private void handleCollectNoteTagMessage(String bodyJsonStr) {
        ...
        //将dto对象转为操作数据库的NoteCollectionDO对象
        NoteCollectionDO noteCollectDO = NoteCollectionDO.builder()
