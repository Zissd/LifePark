package com.lifepark.user.biz.exception;
...
@ControllerAdvice
//能捕获控制器层中抛出的、且能被 Spring MVC 的 DispatcherServlet 处理的异常，
//配合@ExceptionHandler注解使用，可精准捕获不同类型的异常（如业务异常、系统异常、参数校验异常等）并返回标准化结果：
@Slf4j
