package com.lifepark.user.biz.enums;

import com.lifepark.framework.common.exception.BaseExceptionInterface;
...
public enum ResponseCodeEnum implements BaseExceptionInterface {
    ...
    LIFEPARK_ID_VALID_FAIL("USER-20002", "LifePark号请设置6-15个字符，仅可使用英文（必须）、数字、下划线"),
