package com.lifepark.user.biz.runner;
...
//import com.lifepark.auth.domain.dataobject.PermissionDO;
//import com.lifepark.auth.domain.dataobject.RoleDO;
//import com.lifepark.auth.domain.dataobject.RolePermissionDO;
//import com.lifepark.auth.domain.mapper.PermissionDOMapper;
//import com.lifepark.auth.domain.mapper.RoleDOMapper;
//import com.lifepark.auth.domain.mapper.RolePermissionDOMapper;
import com.lifepark.user.biz.constant.RedisKeyConstants;
import com.lifepark.user.biz.domain.dataobject.PermissionDO;
import com.lifepark.user.biz.domain.dataobject.RoleDO;
import com.lifepark.user.biz.domain.dataobject.RolePermissionDO;
import com.lifepark.user.biz.domain.mapper.PermissionDOMapper;
import com.lifepark.user.biz.domain.mapper.RoleDOMapper;
import com.lifepark.user.biz.domain.mapper.RolePermissionDOMapper;
...
@Component
@Slf4j
//实现 ApplicationRunner接口 接口提供了一种在 Spring Boot 应用启动后执行特定代码的方式。run()
public class PushRolePermissions2RedisRunner implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        try {
            // 是否能够同步数据: 原子操作
            // 只有在键 PUSH_PERMISSION_FLAG 不存在时，才会设置该键的值为 "1"，并设置过期时间为 1 天
            ...
            if (CollUtil.isNotEmpty(roleDOS)) {
                ...
                List<RolePermissionDO> rolePermissionDOS = rolePermissionDOMapper
                ...
                roleDOS.forEach(roleDO -> {
                    ...
                    if (CollUtil.isNotEmpty(permissionIds)) {
                        ...
                        permissionIds.forEach(permissionId -> {
                            ...
                            //只把permissionKeys即（app:comment:publish）存入redis 方便后续网关权限比较
