package com.lifepark.count.biz.constant;
...
public class RedisKeyConstants {
    ...
    /**
     * Hash Field: 粉丝总数 对应的 Field 名称
     */
    public static final String FIELD_FANS_TOTAL = "fansTotal";

    /**
     * Hash Field: 关注总数 对应的 Field 名称
     */
    ...
    /**
     * Hash Field: 笔记点赞总数  对应的 Field 名称
     */
    public static final String FIELD_LIKE_TOTAL = "likeTotal";

    /**
     * Hash Field: 笔记收藏总数 对应的 Field 名称
     */
    ...
    /**
     * 构建用户维度计数 Key  存储hash结构 key为关注数与粉丝数followingTotal  fansTotal
     * @param userId
     * @return
     */
    ...
    /**
     * 构建笔记维度计数 Key  存储hash结构 key为笔记点赞数likeTotal collectTotal
     * @param noteId
     * @return
     */
